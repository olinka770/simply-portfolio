...
function move() {
    ...
    //the '10 refers to the height from the bottom of the sky section. I added this in CSS file. 
    //Feel free to move all styling to the js file if you prefer to keep the '10' consistent.    
